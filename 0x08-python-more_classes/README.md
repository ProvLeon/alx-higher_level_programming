...
Project done during **Full Stack Software Engineering Studies by ALX SE** . It aims to equip the student about Object Oriented Programming (OOP), Data Abstraction, Data Encapsulation, instances and classes attributes in **Python**.
